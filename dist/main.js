...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"searchTasks\": () => (/* binding */ searchTasks)\n/* harmony export */ });\n/* harmony import */ var _src_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/index */ \"./src/index.js\");\n\n  \n  const searchTasks = (() => {\n    const searchBar = document.querySelector(\"#searchBar\");\n  \n    searchBar.addEventListener(\"keyup\", (e) => {\n      const selectedList = _src_index__WEBPACK_IMPORTED_MODULE_0__.lists.find((list) => list.id === _src_index__WEBPACK_IMPORTED_MODULE_0__.selectedListId);\n      const searchString = e.target.value.toLowerCase();\n  \n      const searchedTasks = selectedList.tasks.filter((task) => {\n        return (\n          task.name.toLowerCase().includes(searchString) ||\n          task.description.toLowerCase().includes(searchString)\n        );\n      });\n      renderSearch(searchedTasks);\n    });\n  \n    function renderSearch(searchedTasks) {\n      (0,_src_index__WEBPACK_IMPORTED_MODULE_0__.clearElement)(_src_index__WEBPACK_IMPORTED_MODULE_0__.listsContainer);\n      (0,_src_index__WEBPACK_IMPORTED_MODULE_0__.renderLists)();\n      const selectedList = _src_index__WEBPACK_IMPORTED_MODULE_0__.lists.find((list) => list.id === _src_index__WEBPACK_IMPORTED_MODULE_0__.selectedListId);\n  \n      if (_src_index__WEBPACK_IMPORTED_MODULE_0__.selectedListId === null) {\n        const todoLister = document.querySelector(\".todo-lister\");\n        todoLister.style.display = \"none\";\n        _src_index__WEBPACK_IMPORTED_MODULE_0__.listDisplayContainer.style.background = \"red\";\n      } else {\n        _src_index__WEBPACK_IMPORTED_MODULE_0__.listDisplayContainer.style.display = \"\";\n        _src_index__WEBPACK_IMPORTED_MODULE_0__.listTitleElement.innerHTML = `<i class=\"fas fa-tasks\"></i> ${selectedList.name}`;\n        (0,_src_index__WEBPACK_IMPORTED_MODULE_0__.clearElement)(_src_index__WEBPACK_IMPORTED_MODULE_0__.tasksContainer);\n        renderSearchedTasks(searchedTasks);\n        colorSearchedTasks(searchedTasks);\n      }\n    }\n  \n    function colorSearchedTasks(searchedTasks) {\n      const todos = [...document.querySelectorAll(\".todo\")];\n      const checkbox = [...document.querySelectorAll(\".checkbox\")];\n      for (let i = 0; i < todos.length; i++) {\n        for (let i = 0; i < searchedTasks.length; i++) {\n          if (searchedTasks[i].priority === \"High\") {\n            checkbox[i].style.border = \"2px solid #ed1250\";\n          } else if (searchedTasks[i].priority === \"Medium\") {\n            checkbox[i].style.border = \"2px solid #d3d00f\";\n          } else {\n            checkbox[i].style.border = \"2px solid #0fc53d\";\n          }\n        }\n      }\n    }\n  \n    function renderSearchedTasks(searchedTasks) {\n      searchedTasks.forEach((task) => {\n        const taskElement = document.importNode(_src_index__WEBPACK_IMPORTED_MODULE_0__.taskTemplate.content, true);\n        const checkbox = taskElement.querySelector(\"input\");\n        checkbox.id = task.id;\n        checkbox.checked = task.complete;\n        const label = taskElement.querySelector(\"label\");\n        label.htmlFor = task.id;\n  \n        const lineBreak = document.createElement(\"br\");\n        label.append(task.name, \", \", task.date, lineBreak, task.description);\n        const editButton = document.createElement(\"p\");\n        editButton.innerHTML = `<i class=\"far fa-edit\"></i>`;\n        editButton.classList.add(\"edit\");\n        editButton.addEventListener(\"click\", () => (0,_src_index__WEBPACK_IMPORTED_MODULE_0__.editTask)(task, label));\n        const todoTask = taskElement.querySelector(\".task\");\n        todoTask.append(editButton);\n        _src_index__WEBPACK_IMPORTED_MODULE_0__.tasksContainer.appendChild(taskElement);\n      });\n    }\n  })();\n  \n  \n  \n\n//# sourceURL=webpack://todo-list/./src/searchbar.js?");
